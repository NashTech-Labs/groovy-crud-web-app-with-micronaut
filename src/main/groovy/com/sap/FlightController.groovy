...
class FlightController {
    ...
    FlightRepository sFlightRepository
    ...
    Map create(@Body FlightEntity sFlightEntity) {
        try {
    ...
    @View('action')
    //only admin can perform the operations.
    Map update(@Body FlightEntity sFlightEntity, @PathVariable('id') String id) {
        try {
    ...
    @View('action')
    //only admin can perform the operations.
    Map delete(@Body FlightEntity sFlightEntity, @PathVariable('id') String id) {
        try {
    ...
    Map<String, Object> operation(@Nullable @PathVariable('name') String name) {
        ...
        Integer id
        FlightEntity sFlightEntity
        switch (operationName) {
            case 'POST':
                return ['sFlight': new FlightEntity(), 'operation': name]
            case 'PUT':
            case 'DELETE':
